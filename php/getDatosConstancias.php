...
if($_POST){
  ...
  if (is_dir("../archivosValidarCurso/" . $mostrar[6])) $varExisteDir = "True";
  else $varExisteDir = "False";

	echo json_encode(array("folio"=>$folio, "nombreEvento"=>$mostrar[1], "nombreCursante" =>$mostrar[2], "nombreInstancia" =>$mostrar[3], "fechaEmision" =>$mostrar[4], "comentarios" =>$mostrar[5], "idEvento" => $mostrar2[0], "existeDir" => $varExisteDir));
}
