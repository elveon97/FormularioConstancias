...
if($_POST){
  ...
  if (is_dir("../archivosValidarCurso/" . $mostrar[9])) $varExisteDir = "True";
  else $varExisteDir = "False";

	echo json_encode(array("folio"=>$folio, "nombreEvento"=>$mostrar[1], "nombreCursante" =>$mostrar[2], "nombreInstancia" =>$mostrar[3], "fechaInicio" =>$mostrar[4], "fechaFin" =>$mostrar[5], "fechaEmision" =>$mostrar[6], "duracion" =>$mostrar[7], "comentarios" =>$mostrar[8],"idEvento"=>$mostrar2[0], "existeDir"=>$varExisteDir));
}
